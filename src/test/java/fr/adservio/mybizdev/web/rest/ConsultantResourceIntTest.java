...
public class ConsultantResourceIntTest {
    ...
    private static final Integer DEFAULT_TJ_M_FINAL = 1;
    private static final Integer UPDATED_TJ_M_FINAL = 2;
    ...
    public void createConsultant() throws Exception {
        ...
        assertThat(testConsultant.getTjMFinal()).isEqualTo(DEFAULT_TJ_M_FINAL);
        assertThat(testConsultant.getDateDebutInterco()).isEqualTo(DEFAULT_DATE_DEBUT_INTERCO);
        assertThat(testConsultant.getDateDemarrage()).isEqualTo(DEFAULT_DATE_DEMARRAGE);
    }
    ...
    @Test
    @Transactional
    public void checkTjMinIsRequired() throws Exception {
        int databaseSizeBeforeTest = consultantRepository.findAll().size();
        // set the field null
        consultant.setTjMin(null);
    ...
    public void getAllConsultants() throws Exception {
        ...
        restConsultantMockMvc.perform(get("/api/consultants?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tjMFinal").value(hasItem(DEFAULT_TJ_M_FINAL)))
    ...
    public void getConsultant() throws Exception {
        ...
        restConsultantMockMvc.perform(get("/api/consultants/{id}", consultant.getId()))
            ...
            .andExpect(jsonPath("$.tjMFinal").value(DEFAULT_TJ_M_FINAL))
    ...
    public void updateConsultant() throws Exception {
        ...
        assertThat(testConsultant.getTjMFinal()).isEqualTo(UPDATED_TJ_M_FINAL);
        assertThat(testConsultant.getDateDebutInterco()).isEqualTo(UPDATED_DATE_DEBUT_INTERCO);
        assertThat(testConsultant.getDateDemarrage()).isEqualTo(UPDATED_DATE_DEMARRAGE);
    }
