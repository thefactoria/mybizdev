...
export class ConsultantService {
    ...
    private convertItemFromServer(consultant: Consultant): Consultant {
        ...
        copy.dateIntegration = this.dateUtils
            .convertDateTimeFromServer(consultant.dateIntegration);
        return copy;
    }
    ...
    private convert(consultant: Consultant): Consultant {
        ...
        copy.dateIntegration = this.dateUtils.toDate(consultant.dateIntegration);
        return copy;
    }
}
